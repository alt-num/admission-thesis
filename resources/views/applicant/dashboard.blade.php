            ...
            <div class="flex">
                ...
                <div class="ml-3 flex-1">
                    <p class="text-sm text-yellow-700">
                        <strong>Your application form needs corrections.</strong> Please update your information.
                    </p>
                    <div class="mt-2">
    ...
    @if(empty($applicant->photo_path))
        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-700">
                        <strong>Your ID photo was rejected.</strong> Please upload a new one to continue.
                    </p>
                    <div class="mt-2">
                        <a href="{{ route('applicant.profile.show') }}" 
                           class="inline-flex items-center px-3 py-2 bg-yellow-600 text-white text-sm font-medium rounded-lg hover:bg-yellow-700 transition-colors">
