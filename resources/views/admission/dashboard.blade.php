...
@section('title', 'Dashboard - ESSU Admission System')

@section('content')
<div class="space-y-6">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">Dashboard</h1>
        <p class="mt-2 text-sm text-gray-600">Overview of applicants and exams</p>
    </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-2xl font-semibold text-gray-900">{{ $totalApplicants }}</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-2xl font-semibold text-gray-900">{{ $pendingApplicants }}</dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-2xl font-semibold text-gray-900">{{ $totalExams }}</dd>
                    </dl>
                </div>
            </div>
        </div>
