...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-4">
        <form method="GET" action="{{ route('admission.employees.index') }}" class="space-y-4">
            <div class="flex items-center space-x-4">
                ...
                <div class="w-48">
                    <label for="filter" class="sr-only">Filter employees</label>
                    <select name="filter" 
                            id="filter"
                            class="block w-full py-2 px-3 border border-gray-300 bg-white rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        <option value="">All Employees</option>
                        <option value="has_account" {{ request('filter') === 'has_account' ? 'selected' : '' }}>Has Account</option>
                        <option value="no_account" {{ request('filter') === 'no_account' ? 'selected' : '' }}>No Account</option>
                    </select>
                </div>
